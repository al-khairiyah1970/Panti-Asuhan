...
<body>
    ...
    <main class="container mx-auto mt-5 pb-3">
        <h1>Tambah Data Program Bulanan</h1>
        <div class="border-top mt-5 pt-5">
            <form action="{{ route('add_program_aksi') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="jenis" value="bulanan" readonly required>
                <div class="col-md-12">
